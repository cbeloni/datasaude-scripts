#!/usr/bin/env python3
"""Importa Agregados_por_setores_pessoas_indigenas_BR_filtrado.csv para MongoDB."""
...
def main() -> None:
    ...
    print(f"Importacao concluida: {CSV_PATH.name} -> setores_pessoas_indigenas_br_filtrado")
