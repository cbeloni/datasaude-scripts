#!/usr/bin/env python3
"""Importa Agregados_por_setores_caracteristicas_domicilio1_BR.csv para MongoDB."""
...
def main() -> None:
    ...
    print(f"Importacao concluida: {CSV_PATH.name} -> setores_caracteristicas_domicilio1_br")
